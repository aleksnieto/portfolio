...
function Section(){
    ...
    return (
        <section className="max-md:gap-20 max-md:flex max-md:flex-col max-md:w-12/12 max-md:h-12/12 dark:bg-slate-950 dark:text-white">
            ...
            <div data-aos="fade-up" data-aos-duration="800">
                <article className="mx-auto p-16 flex gap-12 max-md:flex-col max-md:gap-6 max-md:w-12/12 max-md:m-0 max-md:p-0 dark:bg-slate-950">
                    <div className=" w-4/4 md:w-1/4 flex justify-end max-md:justify-normal"><p className="uppercase text-xl font-extrabold text-blue-500 tracking-widest ">{t("Work")}</p></div>
                    <div className="gap-8   w-3/4 flex flex-col max-md:m-0 max-md:w-full text-lg text-left max-md:text-sm">
                        <div className="experience flex flex-col gap-2">
                            <div className="header-work border-l border-blue-500 pl-3 flex flex-col md:flex-row gap-1 md:gap-4 md:items-center">
                                <span class="uppercase font-semibold text-sm md:text-lg">Grupo Digital</span>
                                <span class="text-sm italic text-gray-500 text-xs">FRONT-END DEVELOPER  |  2025 - Actualmente</span>
                            </div>
                            <p>{t("WorkGrupoDigital")}</p>
                        </div>
                        <div className="experience flex flex-col gap-2">
                            <div className="header-work border-l border-blue-500 pl-3 flex flex-col md:flex-row gap-1 md:gap-4 md:items-center">
                                <span class="uppercase font-semibold text-sm md:text-lg">Grupo NGN</span>
                                <span class="text-sm italic text-gray-500 text-xs">SOFTWARE DEVELOPER  |  2024 - 2025</span>
                            </div>
                            <p>{t("WorkGrupoNgn")}</p>
                        </div>
                        <div className="experience flex flex-col gap-2">
                            <div className="header-work border-l border-blue-500 pl-3 flex flex-col md:flex-row gap-1 md:gap-4 md:items-center">
                                <span class="uppercase font-semibold text-sm md:text-lg">Controlnet</span>
                                <span class="text-sm italic text-gray-500 text-xs">FULLSTACK DEVELOPER  |  2024 - 2025</span>
                            </div>
                            <p>{t("WorkControlnet")}</p>
            ...
            <div data-aos="fade-up" data-aos-duration="800">
                <article className="mx-auto p-16 flex gap-12 max-md:flex-col max-md:p-0 max-md:h-2/2 max-md:gap-6 max-md:w-full dark:text-white">
                    ...
                    <div className="project flex flex-col gap-4">
                        ...
                        <p className="font-bold text-l text-zinc-700 text-lg max-md:text-sm text-left flex gap-2 dark:text-white">Ezbarbers<a href="" target="_blank" rel="noreferrer"><Email viewBox = "0 0 24 24"/></a></p>
                            <p className="text-gray-700 text-lg max-md:text-sm text-left dark:text-white">{t("ProjectEzbarbers")}</p>
                        </div>
                        <div className="flex flex-col max-md:w-full gap-3">
                            <div className="gap-2 flex max-md:grid max-md:grid-cols-3  max-md:w-2/2 uppercase font-extrabold text-center items-center">
                                ...
                                <Technology name="PrimeNG" />
                                <Technology name="Primeflex" />
                    ...
                    <div className="project flex flex-col gap-4">
                        <div className="flex gap-2 flex-col max-md:w-full">
                        <p className="font-bold text-l text-zinc-700  text-lg max-md:text-sm text-left flex gap-2 dark:text-white">Snake Barber<a href="https://www.snakebarber.com" target="_blank" rel="noreferrer"><Email className="hover:cursor-pointer" viewBox = "0 0 24 24"/></a></p>
                    ...
                    <div className="project flex flex-col gap-4">
                        <div className="flex gap-2 flex-col max-md:w-full">
                        <p className="font-bold text-l text-zinc-700 text-lg max-md:text-sm text-left flex gap-2 dark:text-white">CryptoTracks<a href="" target="_blank" rel="noreferrer"><Email viewBox = "0 0 24 24"/></a></p>
                            <p className="text-gray-700 text-lg max-md:text-sm text-left dark:text-white">{t("ProjectCryptoTracks")}</p>
                        </div>
                        <div className="flex flex-col max-md:w-full gap-3">
                            <div className="gap-2 flex max-md:grid max-md:grid-cols-3  max-md:w-2/2 uppercase font-extrabold text-center items-center">
                    ...
                    <div className="project flex flex-col gap-4">
                        <div className="flex gap-2 flex-col max-md:w-full">
                        <p className="font-bold text-l text-zinc-700 text-lg max-md:text-sm text-left flex gap-2 dark:text-white">Portfolio<a href="" target="_blank" rel="noreferrer"><Email viewBox = "0 0 24 24"/></a></p>
